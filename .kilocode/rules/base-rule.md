...
1. Memory Bank: Read ALL files in `.kilocode/rules/memory-bank` at the start of every task and include “[Memory Bank: Active]” or “[Memory Bank: Missing]” in responses — see [`​.kilocode/rules/memory-bank/memory-bank-instructions.md`](.kilocode/rules/memory-bank/memory-bank-instructions.md:1).  
...
- Read memory-bank files and confirm “[Memory Bank: Active]”. ([`​.kilocode/rules/memory-bank/memory-bank-instructions.md`](.kilocode/rules/memory-bank/memory-bank-instructions.md:1))  
...
- Memory Bank operations (initialize/update memory bank) → [`​.kilocode/rules/memory-bank/memory-bank-instructions.md`](.kilocode/rules/memory-bank/memory-bank-instructions.md:1)
