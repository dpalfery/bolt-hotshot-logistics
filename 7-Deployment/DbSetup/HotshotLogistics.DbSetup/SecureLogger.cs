...
#pragma warning disable CS8603 // Possible null reference return
            string sanitizedConnectionString = MaskConnectionStringSecrets(connectionString);
#pragma warning restore CS8603 // Possible null reference return
        ...
        private string SanitizeMessage(string message)
        {
            ...
            sanitized = Regex.Replace(sanitized, @"password['""\s]*=[\s]*['""][^'""]*['""]", "password=\"REDACTED\"",
                RegexOptions.IgnoreCase);
            sanitized = Regex.Replace(sanitized, @"pwd['""\s]*=[\s]*['""][^'""]*['""]", "pwd=\"REDACTED\"",
                RegexOptions.IgnoreCase);
