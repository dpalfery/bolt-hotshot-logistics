...
namespace HotshotLogistics.Contracts.Services
{
    ...
    public interface ITrackingService
    {
        ...
        Task<LocationTracking> UpdateLocationAsync(string jobId, int driverId, LocationUpdate locationUpdate,
        ...
        Task<IEnumerable<LocationTracking>> GetLocationHistoryAsync(string jobId, DateTime startTime, DateTime endTime,
            CancellationToken cancellationToken = default);
        ...
        Task<bool> CheckRouteDeviationAsync(string jobId, LocationUpdate currentLocation,
            CancellationToken cancellationToken = default);
    }
}
