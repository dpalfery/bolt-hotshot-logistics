...
namespace HotshotLogistics.Contracts.Services
{
    ...
    public interface IJobAssignmentService
    {
        ...
        Task<IEnumerable<JobAssignmentDto>> GetByDriverIdAsync(int driverId,
        ...
        Task<IEnumerable<JobAssignmentDto>>
            GetByJobIdAsync(string jobId, CancellationToken cancellationToken = default);
        ...
        Task<JobAssignmentDto> AssignJobAsync(string jobId, int driverId,
            CancellationToken cancellationToken = default);
        ...
        Task<JobAssignmentDto> UpdateAssignmentStatusAsync(string id, JobAssignmentStatus status,
            CancellationToken cancellationToken = default);
