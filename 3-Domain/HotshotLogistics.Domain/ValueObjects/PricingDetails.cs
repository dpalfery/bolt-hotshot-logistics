...
namespace HotshotLogistics.Domain.ValueObjects
{
    ...
    public class PricingDetails
    {
        ...
        {
            decimal mileageCharges = MileageRate * distance;
            decimal subtotal = BaseRate + mileageCharges + FuelSurcharge + TollCharges + AdditionalCharges;

            decimal discountedAmount = subtotal - Discount;
        ...
        public void ApplyDiscount(decimal discountAmount, bool recalculate = true)
        {
            ...
            if (recalculate)
            {
                decimal subtotal = BaseRate + FuelSurcharge + TollCharges + AdditionalCharges;
                decimal discountedAmount = subtotal - Discount;
