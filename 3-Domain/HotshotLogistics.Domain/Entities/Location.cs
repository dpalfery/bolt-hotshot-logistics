...
namespace HotshotLogistics.Domain.Entities
{
    ...
    public class Location
    {
        ...
        public double? DistanceTo(Location other)
        {
            ...
            double lat1Rad = (double)(Latitude!.Value * (decimal)Math.PI / 180);
            double lat2Rad = (double)(other.Latitude!.Value * (decimal)Math.PI / 180);
            double deltaLatRad = (double)((other.Latitude!.Value - Latitude!.Value) * (decimal)Math.PI / 180);
            double deltaLonRad = (double)((other.Longitude!.Value - Longitude!.Value) * (decimal)Math.PI / 180);
        ...
        public bool IsValid()
        {
            return !string.IsNullOrWhiteSpace(Address) &&
                   ...
                   Latitude is null or >= -90 and <= 90 &&
                   Longitude is null or >= -180 and <= 180;
        }
    }
}
