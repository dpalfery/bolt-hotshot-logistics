...
namespace HotshotLogistics.Domain.Entities
{
    ...
    public class Job
    {
        ...
        /// </summary>
        public PricingDetails Pricing { get; set; } = new();
        ...
        /// </summary>
        public List<JobDocument> Documents { get; set; } = new();
        ...
        {
            Pricing.TotalAmount = Pricing.BaseRate + (Pricing.MileageRate * (decimal)distance) + Pricing.FuelSurcharge +
                                  Pricing.TollCharges + Pricing.AdditionalCharges;
        }
        ...
        {
            JobDocument? document = Documents.FirstOrDefault(d => d.Id == documentId);
            if (document != null)
            {
        ...
        {
            LocationUpdate? currentLocation = GetCurrentLocation();
            ...
            TimeSpan totalDuration = EstimatedDeliveryTime - ScheduledPickupTime;
            TimeSpan elapsed = DateTime.UtcNow - ScheduledPickupTime;
