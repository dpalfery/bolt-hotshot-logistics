...
namespace HotshotLogistics.Domain.Entities
{
    ...
    public class LocationUpdate
    {
        ...
        public double? DistanceTo(Location location)
        {
            ...
            double lat1Rad = (double)(Latitude * (decimal)Math.PI / 180);
            double lat2Rad = (double)(location.Latitude!.Value * (decimal)Math.PI / 180);
            double deltaLatRad = (double)((location.Latitude!.Value - Latitude) * (decimal)Math.PI / 180);
            double deltaLonRad = (double)((location.Longitude!.Value - Longitude) * (decimal)Math.PI / 180);
