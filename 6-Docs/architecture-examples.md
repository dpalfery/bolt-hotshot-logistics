...
This document contains detailed implementation examples for the consolidated Architecture Rules. These examples demonstrate proper usage of Clean Architecture, native ADO.NET, and ASP.NET Core practices in Hotshot Logistics.
...
### FluentMigrator Migration Structure
```csharp
