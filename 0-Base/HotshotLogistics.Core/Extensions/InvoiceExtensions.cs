...
namespace HotshotLogistics.Core.Extensions
{
    ...
    public static class InvoiceExtensions
    {
        ...
        public static bool IsOverdue(this IInvoice invoice)
        {
            if (invoice == null)
                return false;
        ...
        public static int DaysOverdue(this IInvoice invoice)
        {
        ...
        public static bool IsEligibleForEarlyDiscount(this IInvoice invoice)
        {
        ...
        public static decimal CalculateEarlyPaymentDiscount(this IInvoice invoice)
        {
        ...
        public static string GetStatusDisplay(this IInvoice invoice)
        {
            if (invoice == null)
                return "Unknown";
