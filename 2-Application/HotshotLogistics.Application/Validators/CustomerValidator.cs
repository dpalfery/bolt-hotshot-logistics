    ...
    public class CustomerValidator : AbstractValidator<Customer>
    {
        ...
        public CustomerValidator()
        {
            ...
            RuleFor(x => x.TaxId)
                ...
                .Matches(@"^[0-9\-]+$").When(x => !string.IsNullOrEmpty(x.TaxId))
            ...
            RuleFor(x => x.Phone)
                ...
                .When(x => !string.IsNullOrEmpty(x.Phone)).WithMessage("A valid US phone number is required.")
    ...
    public class CreditTermsValidator : AbstractValidator<CreditTerms>
    {
        ...
        public CreditTermsValidator()
        {
            ...
            RuleFor(x => x.ExpiryDate)
                .GreaterThan(x => x.ApprovedDate).When(x => x.ExpiryDate.HasValue)
                .WithMessage("Expiry date must be after approved date.")
