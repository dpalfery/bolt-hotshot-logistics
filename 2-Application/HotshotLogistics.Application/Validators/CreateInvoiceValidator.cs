    ...
    public class CreateInvoiceValidator : AbstractValidator<Invoice>
    {
        ...
        public CreateInvoiceValidator()
        {
            RuleFor(x => x.InvoiceNumber)
                ...
                .Matches(@"^[A-Z0-9\-]+$")
                .WithMessage("Invoice number can only contain letters, numbers, and hyphens.");
            ...
            RuleFor(x => x.DueDate)
                ...
                .LessThan(x => x.InvoiceDate.AddDays(365))
                .WithMessage("Due date cannot be more than 365 days after invoice date.");
            ...
            RuleFor(x => x.SubTotal)
                ...
                .Equal(x => x.LineItems.Sum(li => li.Amount))
                .WithMessage("Subtotal must equal the sum of line item amounts.");
            ...
            RuleFor(x => x.TaxAmount)
                ...
                .Equal(x => Math.Round(x.SubTotal * x.TaxRate, 2))
                .WithMessage("Tax amount must be correctly calculated.");
            ...
            RuleFor(x => x.TotalAmount)
                ...
                .Equal(x => x.SubTotal + x.TaxAmount - x.DiscountAmount)
                .WithMessage("Total amount must be correctly calculated.");
            ...
            RuleFor(x => x.BalanceDue)
                .Equal(x => x.TotalAmount - x.PaidAmount)
                .WithMessage("Balance due must equal total amount minus paid amount.");
