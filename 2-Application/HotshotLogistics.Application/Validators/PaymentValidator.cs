...
namespace HotshotLogistics.Application.Validators
{
    ...
    public class PaymentValidator : AbstractValidator<Payment>
    {
        ...
        public PaymentValidator()
        {
            ...
            RuleFor(x => x.PaymentDate)
                ...
                .WithMessage("Payment date cannot be more than 30 days in the past.");
            ...
            RuleFor(x => x.TransactionId)
                ...
                .Matches(@"^[A-Za-z0-9\-_]+$").When(x => !string.IsNullOrEmpty(x.TransactionId))
        ...
        private static bool NotBeDuplicateTransaction(Payment payment)
        {
    ...
    public class ProcessPaymentValidator : AbstractValidator<Payment>
    {
        ...
        public ProcessPaymentValidator()
        {
            ...
            RuleFor(x => x.PaymentMethod)
                .NotEqual(PaymentMethodType.Cash).When(x => x.Amount > 10000)
                .WithMessage("Cash payments cannot exceed $10,000.");
        }
    }
